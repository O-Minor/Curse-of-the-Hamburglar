...
def scene_two(character):
  ...
  if (character) == "Fredrick":
      ...
      if item_used.lower() == "accordion":
        ...
        p('"Impressive" Mike says, "but I was thinking something a little less polka. How a rap battle?" You accept.')
    ...
    for i in range (3):
      ...
      if obstacle == "tree" and tool.lower() == "chain saw":
        ...
        p("Nice, you got past!")
      elif  obstacle == "tree" and tool.lower() == "chainsaw":
        p("Nice, you got past!")
...
def final_battle(character):
  ...
  if character == "Fredrick":
    ...
    p("Your actions are 'play accordion' - a parry move or 'dance to the side' - a dodge move. Dodge his pies and parry his sword.")
  else:
    actions.append("cut with chainsaw")
    actions.append("roll to the side")
    p("Your actions are 'cut with chainsaw' - a parry move or 'roll to the side' - a dodge move. Dodge his pies and parry his sword")
  ...
  while health > 0:
      ...
      p(string)
      action = input("> ")
      if threat == "throw a pie at you" and action.lower() == "dance to the side":
        p("Nice, you dodged!")
        ...
        p(string)
      elif threat == "throw a pie at you" and action.lower() == "roll to the side":
        p("Nice, you dodged!")
